...
### Clúster particional usant l'algorisme de Lloyd
...
Notem que les dues primeras components suman més del 72% de la variança.
...
```{r}
clusters <- cutree(tree = hc_completo, k = 7) 
